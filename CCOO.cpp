...
static const char RAW_GRID[N][N + 1] = {
    "...W.",   // row  1 (0-idx 0)  — agent start
    ".....",   // row  2  Wumpus@(1,1)   Pit@(1,4)
    "....W",   // row  3  TimeZone@(2,7)
             // row  4  Pit@(3,2) Wumpus@(3,4) Pit@(3,10)
    "P...G",   // row  5  TimeZone@(4,8)
    ".TTT."   // row  6  Wumpus@(5,3)  Pit@(5,12)
                        // row  7  TimeZone@(6,6)
                        // row  8  Wumpus@(7,8)  TimeZone@(7,14)
                       // row  9  Pit@(8,2)
                       // row 10  Wumpus@(9,10)  Pit@(9,14)
                       // row 11  TimeZone@(10,5)
                      // row 12  Wumpus@(11,12)
     // row 13  Pit@(12,3)  TimeZone@(12,14)
       // row 14  Wumpus@(13,6)
                               // row 15  Pit@(14,11)
                               // row 16  Wumpus@(15,15)
   // row 17  Goal@(16,16)
